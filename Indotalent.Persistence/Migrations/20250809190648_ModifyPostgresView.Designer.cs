...
namespace Indotalent.Persistence.Migrations
{
    ...
    [Migration("20250809190648_ModifyPostgresView")]
    partial class ModifyPostgresView
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Indotalent.Domain.Grid.ColumnModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool?>("AllowReordering")
                        .HasColumnType("boolean");

                    b.Property<bool?>("AllowResizing")
                        .HasColumnType("boolean");

                    b.Property<bool?>("AllowSearching")
                        .HasColumnType("boolean");
                    ...
                    b.Property<int?>("ClipMode")
                        .HasColumnType("integer");

                    b.Property<string>("CommandsTemplate")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("DefaultValueRaw")
                        .HasColumnType("text")
                        .HasColumnName("DefaultValue");

                    b.Property<bool?>("DisableHtmlEncode")
                        .HasColumnType("boolean");

                    b.Property<bool?>("DisplayAsCheckBox")
                        .HasColumnType("boolean");

                    b.Property<string>("EditTemplate")
                        .HasColumnType("text");

                    b.Property<string>("EditType")
                        .HasColumnType("text");

                    b.Property<bool?>("EnableGroupByFormat")
                        .HasColumnType("boolean");
                    ...
                    b.Property<int?>("HeaderTextAlign")
                        .HasColumnType("integer");

                    b.Property<string>("HideAtMedia")
                        .HasColumnType("text");
                    ...
                    b.Property<bool?>("ShowColumnMenu")
                        .HasColumnType("boolean");

                    b.Property<bool?>("ShowInColumnChooser")
                        .HasColumnType("boolean");

                    b.Property<string>("SortComparer")
                        .HasColumnType("text");
                    ...
                    b.ToTable("ColumnModels");
                });

            modelBuilder.Entity("Indotalent.Domain.Grid.ColumnType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Indotalent.Domain.Grid.Filter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Indotalent.Domain.Grid.Grid", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Indotalent.Domain.Grid.ColumnType", b =>
                {
                    b.HasOne("Indotalent.Domain.Grid.Grid", "Grid")
                        .WithMany("ColumnTypes")
                        .HasForeignKey("GridId");

                    b.HasOne("Indotalent.Domain.Grid.ColumnModel", "Props")
                        .WithMany()
            ...
            modelBuilder.Entity("Indotalent.Domain.Grid.Filter", b =>
                {
                    b.HasOne("Indotalent.Domain.Grid.ColumnType", "ColumnType")
                        .WithMany("Filters")
